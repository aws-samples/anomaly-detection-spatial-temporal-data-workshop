...
from anomaly_detection_spatial_temporal_data.model.data_loader import GraphWNodeFeaturesDataSet, DynamicDatasetLoader
...
def load_data(processed_data, parameters: Dict) -> Dict:
    ...
    dataset = GraphWNodeFeaturesDataSet(p2index, item_features, edgelist_file)
